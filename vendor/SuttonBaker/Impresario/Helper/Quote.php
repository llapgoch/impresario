...
class Quote extends Base
{
    ...
    public function getQuoteProjectTypeCollection()
    {
        ...
        $collection = $this->createAppObject(QuoteDefinition::DEFINITION_QUOTE_PROJECT_TYPE_COLLECTION);
        $collection->order('{{quote_project_type}}.sort_order');
        $collection->order('{{quote_project_type}}.name');
    ...
    public function saveQuote(
        ...
        if (
            $modelInstance->getTenderStatus() !== QuoteDefinition::TENDER_STATUS_OPEN
