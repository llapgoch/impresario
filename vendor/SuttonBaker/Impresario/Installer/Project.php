    ...
    public function install()
    {
        ...
        $this->deltaTable('project',
            "CREATE TABLE `{{tableName}}` (
              ...
              `checklist_plant_off_hired` int(1) DEFAULT '0',
              `checklist_cost_invoice_received_logged` int(1) DEFAULT '0',
              `checklist_rams_qhse_filing` int(1) DEFAULT '0',
              `checklist_customer_satisfaction_survey_logged` int(1) DEFAULT '0',
              `checklist_completion_photos_logged` int(1) DEFAULT '0',
              `checklist_warranty_guarantee_certificate_filed` int(1) DEFAULT '0',
              `checklist_client_advised_operational_maintenance` int(1) DEFAULT '0',
              `checklist_client_crm_updated` int(1) DEFAULT '0',
